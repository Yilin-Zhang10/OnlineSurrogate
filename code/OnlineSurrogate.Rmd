...
## 2.2 Crash V.S. baseline

To further explore the difference between crash and baseline samples, we  plot the density and surrogates for different two cases.
...
We plot the density of acceleration for crash and non-crash data in three dimension and find
